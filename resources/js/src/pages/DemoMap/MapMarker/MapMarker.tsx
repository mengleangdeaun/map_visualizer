...
const MapMarkerDemo = () => {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-100px)] gap-4">
            <PageHeader 
                title="Map Marker Management" 
                subtitle="Add, delete, and explore custom locations with rich popups."
            />
                                ...
                                <MarkerContent>
                                    <div className="relative group/marker cursor-pointer">
                                        ...
                                        <div className={cn(
                                            ...
                                            <div className={cn(
                                                "size-1.5 rounded-full bg-white transition-transform duration-300",
                                                selectedId === marker.id ? "scale-150" : "scale-100"
                                            )} />
                                        </div>
                                    </div>
                                    <MarkerLabel position="top" className={cn(
                                        ...
                                        <div className="p-4 space-y-3">
                                            <div className="flex items-start justify-between gap-2">
                                                <div className="space-y-1 min-w-0">
                                                    ...
                                                    <h4 className="font-bold text-sm leading-tight truncate text-foreground/90">
                                                        {marker.title}
                                                    </h4>
                                                </div>
                                                <Button 
