            ...
            >
                {isAnimating && (
                    <Button 
                        ...
                        className="animate-in fade-in p-4 slide-in-from-right-4 duration-300"
                    >
                ...
                {pickup && dropoff && !isAnimating && status === 'Ready to Start' && (
                    <Button 
                        ...
                        className="bg-emerald-600 p-4 hover:bg-emerald-700 animate-in zoom-in duration-300"
                    >
                ...
                {(status === 'Delivered' || status === 'Delivery Cancelled' || (pickup && !isAnimating && status !== 'Ready to Start')) && (
                    <Button variant="outline" className="p-4" onClick={() => {
                        setPickup(null);
                        setDropoff(null);
                        setRoutes([]);
                        setSelectedIndex(0);
                            ...
                            <MapMarker longitude={searchMarker[0]} latitude={searchMarker[1]}>
                                <MarkerContent>
                                    <div className="relative group">
                                        ...
                                        <MarkerLabel position="top" className="bg-background/70 backdrop-blur-sm px-3 py-2.5 rounded-lg shadow-xl border flex flex-col items-center gap-1.5 min-w-[120px]">
