...
const StartMarkerIcon = () => (
    <div className="size-4 rounded-full bg-green-500 border-2 border-white shadow-md" />
);

const EndMarkerIcon = () => (
    <div className="size-4 rounded-full bg-red-500 border-2 border-white shadow-md" />
);
...
const MapDemo = () => {
    ...
    return (
        <div className="flex flex-col gap-4">
            <PageHeader 
                title="Real-World Travel Route" 
                subtitle="Fetching real-time driving directions from OSRM between Phnom Penh city center and Olympic Market."
            />
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="pt-4 border-t space-y-3">
                                <div className="flex justify-between text-sm">
                                    <span className="text-muted-foreground flex items-center gap-2"><Clock className="size-3.5" /> Time</span>
                                    <span className="font-bold">{routes.length > 0 ? formatDuration(routes[selectedIndex].duration) : "--"}</span>
                                </div>
                                <div className="flex justify-between text-sm">
                                    <span className="text-muted-foreground flex items-center gap-2"><RouteIcon className="size-3.5" /> Distance</span>
