            ...
            <div className="border-b">
                <div className="relative bg-background flex w-full items-center px-5 py-2.5">
                    ...
                    <div className="ltr:mr-2 rtl:ml-2 hidden sm:block">
                        <ul className="flex items-center space-x-2 rtl:space-x-reverse text-muted-foreground">
                            <li>
                                <Link to="/apps/calendar" className="block p-2 rounded-full bg-accent/40 hover:text-primary hover:bg-accent">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li>
                                <Link to="/apps/todolist" className="block p-2 rounded-full bg-accent/40 hover:text-primary hover:bg-accent">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            opacity="0.5"
                            ...
                            <li>
                                <Link to="/apps/chat" className="block p-2 rounded-full bg-accent/40 hover:text-primary hover:bg-accent">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse text-muted-foreground">
                        ...
                        <div className="dropdown shrink-0">
                            <Dropdown
                                ...
                                btnClassName="block p-2 rounded-full bg-accent/40 hover:text-primary hover:bg-accent"
                                button={<img className="w-5 h-5 object-cover rounded-full" src={`/assets/images/flags/${flag.toUpperCase()}.svg`} alt="flag" />}
                            >
                                <ul className="!px-2 text-dark  grid grid-cols-2 gap-2 font-semibold dark:text-muted-foreground w-[280px]">
                        ...
                        <div className="dropdown shrink-0">
                            ...
                            >
                                <ul className="!py-0 text-dark dark:text-foreground w-[300px] sm:w-[375px] text-xs">
                                                    ...
                                                    return (
                                                        <div key={message.id} className="flex items-center py-3 px-5">
                                                            ...
                                                            <span className="px-3 dark:text-gray-500">
                                                                <div className="font-semibold text-sm dark:text-muted-foreground">{message.title}</div>
                                                                <div>{message.message}</div>
                                                            </span>
                                                            <span className="font-semibold bg-muted/20 rounded text-dark/60 px-1 ltr:ml-auto rtl:mr-auto whitespace-pre dark:text-foreground ltr:mr-2 rtl:ml-2">
                                                                {message.time}
                                                            </span>
                        ...
                        <div className="dropdown shrink-0">
                            <Dropdown
                                offset={[0, 8]}
                                placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`}
                                btnClassName="relative block p-2 rounded-full bg-accent/40 hover:text-primary hover:bg-accent"
                                button={
                                    <span>
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            >
                                <ul className="!py-0 text-dark dark:text-foreground w-[300px] sm:w-[350px] divide-y dark:divide-white/10">
                                    <li onClick={(e) => e.stopPropagation()}>
                                    ...
                                    {notifications.length > 0 ? (
                                        <>
                                            {notifications.map((notification) => {
                                                return (
                                                    <li key={notification.id} className="dark:text-muted-foreground" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="dropdown shrink-0 flex">
                            ...
                            >
                                <ul className="text-foreground !py-0 w-[230px] font-semibold">
                                    <li>
                                    ...
                                    <li>
                                        <Link to="/users/profile" className="hover:text-primary transition-colors">
                                    ...
                                    <li>
                                        <Link to="/apps/mailbox" className="hover:text-primary transition-colors">
                                            <svg className="ltr:mr-2 rtl:ml-2 shrink-0" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    opacity="0.5"
                                    ...
                                    <li>
                                        <Link to="/auth/boxed-lockscreen" className="hover:text-primary transition-colors">
                                            <svg className="ltr:mr-2 rtl:ml-2 shrink-0" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                ...
                {/* horizontal menu */}
                <ul className="horizontal-menu hidden py-1.5 font-semibold px-6 lg:space-x-1.5 xl:space-x-8 rtl:space-x-reverse bg-background border-t border-border text-foreground">
                    ...
                    <li className="menu nav-item relative">
                        ...
                        <ul className="sub-menu">
                            ...
                            <li className="relative">
                                ...
                                <ul className="rounded absolute top-0 ltr:left-[95%] rtl:right-[95%] min-w-[180px] bg-card z-[10] text-foreground border border-border shadow p-0 py-2 hidden">
                                    <li>
