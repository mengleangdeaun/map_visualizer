...
const Sidebar = () => {
    ...
    return (
        <div className={semidark ? 'dark' : ''}>
            <nav
                className={`sidebar fixed min-h-screen h-full top-0 bottom-0 w-[260px] border border-r z-50 transition-all duration-300 ${semidark ? 'text-muted-foreground' : ''}`}
            >
                <div className="bg-background h-full">
                    ...
                    <PerfectScrollbar className="h-[calc(100vh-80px)] relative">
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            ...
                            <h2 className="px-7 py-3 text-xs font-bold uppercase tracking-wider text-muted-foreground/70">
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/apps/chat" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3">{t('chat')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/apps/mailbox" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3">{t('mailbox')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/apps/todolist" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3">{t('todo_list')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/apps/notes" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3">{t('notes')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/apps/scrumboard" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3">{t('scrumboard')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/apps/contacts" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3">{t('contacts')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    ...
                                    <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'invoice' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('invoice')}>
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3">{t('invoice')}</span>
                                            </div>
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/apps/calendar" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3">{t('calendar')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                </ul>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'map' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('map')}>
                                    <div className="flex items-center">
                                        <svg className="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3">Demo Maps</span>
                                    </div>

                                    <div className={currentMenu === 'map' ? 'rotate-90' : 'rtl:rotate-180'}>
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 5L15 12L9 19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'map' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/demomap/static">Static Route</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/demomap/interactive">Interactive Route</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/demomap/marker">Map Marker</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/demomap/delivery">Delivery Tracking</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'component' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('component')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3">{t('components')}</span>
                                    </div>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'element' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('element')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3">{t('elements')}</span>
                                    </div>
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/charts" className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3">{t('charts')}</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/widgets" className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3">{t('widgets')}</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/font-icons" className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3">{t('font_icons')}</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/dragndrop" className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3">{t('drag_and_drop')}</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/tables" className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3">{t('tables')}</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'datalabel' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('datalabel')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3">{t('datatables')}</span>
                                    </div>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'forms' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('forms')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3">{t('forms')}</span>
                                    </div>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'page' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('page')}>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3">{t('pages')}</span>
                                    </div>
                                    ...
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li className="menu nav-item">
                                            <button
                                                ...
                                                className={`${
                                                    errorSubMenu ? 'open' : ''
                                                } w-full before:bg-muted-foreground before:w-[5px] before:h-[5px] before:rounded ltr:before:mr-2 rtl:before:ml-2 text-muted-foreground hover:bg-accent`}
