    ...
    return (
        <div>
            ...
            <nav
                ...
                } bg-background fixed ltr:-right-[400px] rtl:-left-[400px] top-0 bottom-0 w-full max-w-[400px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-[right] duration-300 z-[51] p-4`}
            >
                <button
                    type="button"
                ...
                <div className="overflow-y-auto overflow-x-hidden perfect-scrollbar h-full">
                    <div className="text-center relative pb-5">
                        ...
                        <h4 className="mb-1">TEMPLATE CUSTOMIZER</h4>
                        <p className="text-muted-foreground">Set preferences that will be cookied for your live preview demonstration.</p>
                    </div>

                    <div className="border border-dashed border-border rounded-md mb-3 p-3">
                        <h5 className="mb-1 text-base leading-none">Color Scheme</h5>
                        <p className="text-muted-foreground text-xs">Overall light or dark presentation.</p>
                    ...
                    <div className="border border-dashed border-border rounded-md mb-3 p-3">
                        <h5 className="mb-1 text-base leading-none">Navigation Position</h5>
                        <p className="text-muted-foreground text-xs">Select the primary navigation paradigm for your app.</p>
                        <div className="grid grid-cols-3 gap-2 mt-3">
                    ...
                    <div className="border border-dashed border-border rounded-md mb-3 p-3">
                        <h5 className="mb-1 text-base leading-none">Layout Style</h5>
                        <p className="text-muted-foreground text-xs">Select the primary layout style for your app.</p>
                    ...
                    <div className="border border-dashed border-border rounded-md mb-3 p-3">
                        <h5 className="mb-1 text-base leading-none">Direction</h5>
                        <p className="text-muted-foreground text-xs">Select the direction for your app.</p>
                        <div className="flex gap-2 mt-3">
                    ...
                    <div className="border border-dashed border-border rounded-md mb-3 p-3">
                        <h5 className="mb-1 text-base leading-none">Navbar Type</h5>
                        <p className="text-muted-foreground text-xs">Sticky or Floating.</p>
                    ...
                    <div className="border border-dashed border-border rounded-md mb-3 p-3">
                        <h5 className="mb-1 text-base leading-none">Router Transition</h5>
                        <p className="text-muted-foreground text-xs">Animation of main content.</p>
                        <div className="mt-3">
