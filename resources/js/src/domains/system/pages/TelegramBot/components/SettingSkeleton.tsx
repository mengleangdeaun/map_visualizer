  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full h-full p-5">
      ...
      <div className="flex flex-col gap-6 h-full">
        ...
        <div className="border border-zinc-800 bg-zinc-950 p-6 rounded-xl flex flex-col gap-4 flex-1">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Skeleton className="h-10 flex-1 bg-zinc-800 rounded-lg" />
              <Skeleton className="h-10 w-28 bg-zinc-800 rounded-lg" />
            </div>
          </div>
        </div>
        ...
        <div className="border border-zinc-800 bg-zinc-950 p-6 rounded-xl flex flex-col gap-4 flex-1">
          ...
          {/* Trigger Item 1 */}
          <div className="flex justify-between items-center mt-2 border-t border-zinc-900 pt-4">
            <div className="space-y-2 w-2/3">
              <Skeleton className="h-4 w-1/2 bg-zinc-800" />
              <Skeleton className="h-3 w-full bg-zinc-800" />
            </div>
            <Skeleton className="h-6 w-10 bg-zinc-800 rounded-full" />
          </div>
      ...
      <div className="border border-zinc-800 bg-zinc-950 p-6 rounded-xl flex flex-col gap-4 h-full">
        ...
        <div className="space-y-3 mt-4 overflow-hidden">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="flex gap-3 items-start border border-zinc-900 p-3 rounded-lg bg-zinc-950/50">
              <Skeleton className="h-5 w-5 bg-zinc-800 rounded mt-0.5" />
