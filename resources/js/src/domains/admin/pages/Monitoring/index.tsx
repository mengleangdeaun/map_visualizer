...
import { useTasks } from '@/domains/admin/tasks/hooks/useTasks';
...
const MonitoringPage = () => {
    ...
    const handleFocusTarget = (target: { id: string; type: 'vehicle' | 'hub' | 'task'; center: [number, number] }) => {
    ...
    useEffect(() => {
        ...
        if (user.company_id) {
            ...
            // Collect company IDs from currently loaded vehicles and tasks
    ...
    }, [user?.id, vehiclesData?.data.length, tasksData?.data.length, queryClient]);
    ...
    return (
        <div className="h-[calc(100vh-120px)] flex flex-col">
            ...
            <ResizablePanelGroup direction="horizontal" className="flex-1 min-h-0 gap-4">
                ...
                <ResizableHandle withHandle className="bg-transparent hover:bg-primary/10 transition-colors" />
